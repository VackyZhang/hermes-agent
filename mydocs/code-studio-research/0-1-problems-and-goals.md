...
| **阶段 2**（方案设计） | 基于 `1-1` ~ `1-6` 分析，输出 CodeStudio 设计方案 | 完成 `2-1-synthesis-and-design.md` | ✅ 已完成 |
| **阶段 3**（实践验证） | 在 `letsgo_server` 上做 2-3 个真实任务，记录 AI 卡点 | 完成 `3-1-practice-round1.md`、`3-2-practice-round2.md`、`3-3-practice-round3.md` | ⏳ 待开始 |
